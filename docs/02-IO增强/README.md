...
- **内核源码**：[`code/rpi5/kernel/new/vendor/lechao/LcIod/`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/) — LcIod 驱动
- **usb-storage 修改**：[`code/rpi5/kernel/modified/drivers/usb/storage/`](../../code/rpi5/kernel/modified/drivers/usb/storage/) — notifier 注入点
- **用户态源码**：[`code/rpi5/aosp/new/vendor/lechao/services/lechao_lciod/`](../../code/rpi5/aosp/new/vendor/lechao/services/lechao_lciod/) — HAL + Daemon + AIDL
- **SELinux 策略**：[`code/rpi5/aosp/new/device/brcm/rpi5/sepolicy/`](../../code/rpi5/aosp/new/device/brcm/rpi5/sepolicy/) — `lechao_lciod.te` + `lechao_lciod_hal.te`
- **故障注入工具**：[`code/rpi-zero2w/others/usb-fault-inject/`](../../code/rpi-zero2w/others/usb-fault-inject/) — Device 端 12 类故障注入
- **故障校验工具**：[`code/rpi5/others/usb-verify/`](../../code/rpi5/others/usb-verify/) — Host 端统计校验 CLI