...
| 模块 | 职责 | 关键抽象 |
|------|------|---------|
| `lciod_usbd.c` | 字符设备注册、设备生命周期管理、vendor notifier 注册 | `vendor_lechao_usbd_vendor_notifier` — [lciod_usbd.c:657](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L657) |
| `lciod_usbd-stats.c` | notifier 回调、统计更新、degrade 检测、事件推送、LcView 打点 | `vendor_lechao_usbd_handle_event` — [lciod_usbd-stats.c:482](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-stats.c#L482) |
...
魔数 `'R'`，定义在 [lciod_usbd-ioctl.h:146-175](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-ioctl.h#L146)：
...
**两种 degrade 判定条件**（源码 [lciod_usbd-stats.c:600-610](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-stats.c#L600)）：

```c
// lciod_usbd-stats.c:600-610
...
| 不变量 | 保证机制 | 代码位置 |
|--------|---------|---------|
| 设备不重复注册 | 双重检查（mutex 外 + mutex 内） | [`lciod_usbd.c:670-700`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L670) |
| kref 归零时才释放 | `kref_put` + `device_release` 回调 | [`lciod_usbd.c:465-471`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L465) |
| removing 标志原子访问 | `READ_ONCE`/`WRITE_ONCE` | [`lciod_usbd.c:172`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L172) |
...
| 环满时丢弃最旧 | head == tail 时 tail 推进 | [`lciod_usbd-stats.c:379-384`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-stats.c#L379) |
...
| 文件 | 职责 | 关键函数 | 行数 |
|------|------|---------|------|
| `lciod_usbd.c` | 字符设备注册、设备生命周期、vendor notifier | `vendor_lechao_usbd_vendor_notifier`、`vendor_lechao_usbd_monitor_init` | 962 |
| `lciod_usbd-stats.c` | notifier 回调、统计更新、degrade 检测 | `vendor_lechao_usbd_handle_event`、`vendor_lechao_usbd_update_degrade_context_locked` | 695 |
| `lciod_usbd.h` | per-device 结构体、函数原型 | `struct vendor_lechao_usbd_device` | 142 |
| `lciod_usbd-ioctl.h` | ioctl ABI 定义 | `struct vendor_lechao_usbd_stats` | 177 |
...
| 配置项 | 文件 | 说明 |
|--------|------|------|
| 设备节点权限 | [`lciod_usbd.c:120`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L120) | `devnode` 设置 0666 |
...
// lciod_usbd.c:524-528 (错误路径：kref 初始化前需手动 ida_free)
if (!us->pusb_dev) {
...
```c
// lciod_usbd-stats.c:508,653-683
...
|-------------|------|------|-----------|---------|
| `usb_stor_vendor_nh` | blocking | PROBE/DISCONNECT | 进程上下文 | [`lciod_usbd.c:888`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L888) |
| `us->notifier` | atomic | START/END/ERROR/STALL/TIMEOUT/CORRUPT/RESET | 任意上下文 | [`lciod_usbd.c:570`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L570) |
...
实现见 [`lciod_usbd.c:71-85`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L71) 和 [`lciod_usbd-stats.c:189-344`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-stats.c#L189)。
...
> 命令码定义：[`lciod_usbd-ioctl.h:146-175`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-ioctl.h#L146)
...
> `file_operations` 定义：[`lciod_usbd.c:446-453`](../../code/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L446)
