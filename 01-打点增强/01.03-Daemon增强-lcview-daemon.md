...
| 每条记录写入后立即 flush | `FileWriter::writeRecord()` 内 `stream.flush()` | [`FileWriter.cpp:306`](./../patchs/rpi5/aosp/new/vendor/lechao/services/lechao_lcview/daemon/FileWriter.cpp#L306) |
...
| 文件轮转不丢数据 | 轮转时先关闭旧文件再打开新文件，追加模式写入 | [`FileWriter.cpp:329`](./../patchs/rpi5/aosp/new/vendor/lechao/services/lechao_lcview/daemon/FileWriter.cpp#L329) |
