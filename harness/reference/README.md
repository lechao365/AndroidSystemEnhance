...
| 文档 | 规则 ID | 加载时机 | 来源 |
|------|---------|---------|------|
| [env-setup-reference.md](env-setup-reference.md) | ENV-001~007 | 涉及 WSL2 / 宿主环境搭建、AOSP 编译前准备、ADB 工具接入 | 00.1 |
| [build-reference.md](build-reference.md) | BLD-001~013 | 涉及 RPI5 AOSP / 内核编译、源码获取、ccache、打包 | 00.3 + 脚本事实提取 |
...
| [debug-tools-reference.md](debug-tools-reference.md) | DBG-001~008 | 涉及日志抓取、串口调试、WSL 映射 USB 设备 | 00.6（调试部分）+ 00.2 |
