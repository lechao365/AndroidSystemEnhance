#!/usr/bin/env python3
"""sync_workspace_to_code.py — workspace → code/rpi5 全量镜像同步脚本"""
...
def generate_manifest(patch_root: Path, check_only: bool,
    ...
    lines: list[str] = []
    lines.append("# Auto-generated by sync_workspace_to_code.py — patch↔workspace 结构映射。")
...
def main() -> None:
    ...
    harness_init("sync_workspace_to_code")
