...
| 文件 | 职责 | 关键函数 | 行数 |
|------|------|---------|------|
| `lciod_usbd.c` | 字符设备注册、设备生命周期、vendor notifier | `vendor_lechao_usbd_vendor_notifier`、`vendor_lechao_usbd_monitor_init` | 938 |
| `lciod_usbd-stats.c` | notifier 回调、统计更新、degrade 检测 | `vendor_lechao_usbd_handle_event`、`vendor_lechao_usbd_update_degrade_context_locked` | 674 |
