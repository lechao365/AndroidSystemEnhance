...
| 模块 | 职责 | 关键抽象 |
|------|------|---------|
| `lciod_usbd.c` | 字符设备注册、设备生命周期管理、vendor notifier 注册 | `vendor_lechao_usbd_vendor_notifier` — [lciod_usbd.c:657](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L657) |
| `lciod_usbd-stats.c` | notifier 回调、统计更新、degrade 检测、事件推送、LcView 打点 | `vendor_lechao_usbd_handle_event` — [lciod_usbd-stats.c:482](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-stats.c#L482) |
...
| `lciod_usbd-ioctl.h` | 用户态共享 ABI：stats/config/event 结构体 + ioctl 命令码 | `struct vendor_lechao_usbd_stats` — [lciod_usbd-ioctl.h:56](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-ioctl.h#L56) |
...
**helper 函数（inline）：** `usb_stor_notifier_init(us)`、`usb_stor_notifier_call(us, event, data)`、`usb_stor_register_vendor_notifier(nb)`、`usb_stor_unregister_vendor_notifier(nb)` — [usb.h.diff:118-148](./../patchs/rpi5/kernel/modified/drivers/usb/storage/usb.h.diff#L118)
...
[`transport.c.diff`](./../patchs/rpi5/kernel/modified/drivers/usb/storage/transport.c.diff) 新增 7 类事件、共 12 个 `usb_stor_notifier_call()` 调用点：
...
> 完整 diff：[`usb.h.diff`](./../patchs/rpi5/kernel/modified/drivers/usb/storage/usb.h.diff)（151 行）、[`usb.c.diff`](./../patchs/rpi5/kernel/modified/drivers/usb/storage/usb.c.diff)（53 行）、[`transport.c.diff`](./../patchs/rpi5/kernel/modified/drivers/usb/storage/transport.c.diff)（235 行）
...
27 个业务字段（另含 `reserved[3]` 对齐填充），分为四类 — [lciod_usbd-ioctl.h:56-85](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-ioctl.h#L56)
...
魔数 `'R'`，定义在 [lciod_usbd-ioctl.h:146-175](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-ioctl.h#L146)：
...
**两种 degrade 判定条件**（源码 [lciod_usbd-stats.c:600-610](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-stats.c#L600)）：
...
| 不变量 | 保证机制 | 代码位置 |
|--------|---------|---------|
| 设备不重复注册 | 双重检查（mutex 外 + mutex 内） | [`lciod_usbd.c:670-700`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L670) |
| kref 归零时才释放 | `kref_put` + `device_release` 回调 | [`lciod_usbd.c:465-471`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L465) |
| removing 标志原子访问 | `READ_ONCE`/`WRITE_ONCE` | [`lciod_usbd.c:172`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L172) |
| START/END 配对 | ERROR 后立即发射 END | [`transport.c.diff:180-181`](./../patchs/rpi5/kernel/modified/drivers/usb/storage/transport.c.diff#L180) |
| 环满时丢弃最旧 | head == tail 时 tail 推进 | [`lciod_usbd-stats.c:379-384`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-stats.c#L379) |
...
| 配置项 | 文件 | 说明 |
|--------|------|------|
| 设备节点权限 | [`lciod_usbd.c:120`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L120) | `devnode` 设置 0666 |
...
|-------------|------|------|-----------|---------|
| `usb_stor_vendor_nh` | blocking | PROBE/DISCONNECT | 进程上下文 | [`lciod_usbd.c:888`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L888) |
| `us->notifier` | atomic | START/END/ERROR/STALL/TIMEOUT/CORRUPT/RESET | 任意上下文 | [`lciod_usbd.c:570`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L570) |
...
实现见 [`lciod_usbd.c:71-85`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L71) 和 [`lciod_usbd-stats.c:189-344`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-stats.c#L189)。
...
> 命令码定义：[`lciod_usbd-ioctl.h:146-175`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd-ioctl.h#L146)
...
> `file_operations` 定义：[`lciod_usbd.c:446-453`](./../patchs/rpi5/kernel/new/vendor/lechao/LcIod/lciod_usbd.c#L446)
