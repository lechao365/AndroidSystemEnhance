...
| `util.h` | 辅助函数声明 | — | 9 |
| `vendor_lechao_usbd-ioctl.h` | 内核-用户态共享 ABI | `struct vendor_lechao_usbd_stats` / `struct vendor_lechao_usbd_config` / `struct vendor_lechao_usbd_event` / 4 个 IOC 宏 | 164 |
