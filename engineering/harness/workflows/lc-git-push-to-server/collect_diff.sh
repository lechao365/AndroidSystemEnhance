...
# 用法:    bash engineering/harness/workflows/lc-git-push-to-server/collect_diff.sh [--stat-only]
...
for arg in "$@"; do
    case "$arg" in
        ...
        -h|--help)
            echo "Usage: bash engineering/harness/workflows/lc-git-push-to-server/collect_diff.sh [--stat-only]"
